...
class Pagination {
    ...
    public function get() {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            if ($page == $this->current_page) {
                $links .= '<li class="page_active"><span">'.$page.'</span></li>';
            } else {
    ...
    private function generateHtml($page, $text = null) {
        ...
        return '<li class="page-item"><a class="page-link" href="/'.$this->route['controller'].'/'.$this->route['action'].'/page='.$page.'">'.$text.'</a></li>';
    }
